...
import com.example.inplicitintent.databinding.FragmentFirstBinding;
...
//                startActivity(browserIntent);
                ...
                // implicit intent to open email
                String [] addresses = {"priyanshumallick123456@gmail.com"};
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setType("*/*");
                intent.setData(Uri.parse("mailto:"));
                intent.putExtra(Intent.EXTRA_EMAIL,addresses);
                intent.putExtra(Intent.EXTRA_SUBJECT,"Guddu Subject");
